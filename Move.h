...
public:
	...
	*/
	...
	/* Returns true iff the move is a PLACE move */
	bool isWord () const { return true;}

	/* First X tile of the move */
	size_t getStartX() const {return x;}

	/* First Y tile of the move */
	size_t getStartY() const {return y;}

	/* gets the string of tiles */
	std::string getPlaceString() const {return placeString;}

	/* returns whether or not placement is horizontal */
	...
	/* checks that tiles are placed adjacently to one another*/
	bool adjacency(Board & board);
